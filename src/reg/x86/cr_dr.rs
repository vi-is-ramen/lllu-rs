...
impl super::Register<{ size_of::<usize>() }> for Cr1 {
    ...
    unsafe fn try_write_raw(&mut self, _value: [u8; size_of::<usize>()]) -> Option<()> {
        None
    }
...
impl Cr2Value {
    ...
    // It does not have individual feature bits, but you can extract the address:
...
impl Cr4Value {
    ...
    pub const fn os_support_unmasked_simd_floating_point_exceptions(self) -> Self {
        self.set_bit(10)
    }
